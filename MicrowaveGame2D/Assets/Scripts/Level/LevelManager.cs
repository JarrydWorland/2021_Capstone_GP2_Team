...
namespace Level
{
	public class LevelManager : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			GameObject startingRoomObject = Room.Make(startingRoomPrefab, transform, new Vector2Int());
		...
		private void SpawnRooms(Room room, int depth)
		{
			...
			while ((currentDoor = room.Doors.FirstOrDefault(x => x.ConnectingDoor == null)) != null)
			{
				...
				GameObject oppositeRoomObject = Room.Make(oppositeRoomPrefab, transform, new Vector2Int());
